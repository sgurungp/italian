...
Regular nouns, see Table \ref{tab:tATPG-Feb28-part1}:
...
\centering
    ...
    \end{tabular}
    \caption{ATPG, Feb 28 - regular nouns}
    \label{tab:tATPG-Feb28-part1}
\end{table}
...
\centering
    \begin{tabular}{ r l | r l | r l }
         \itb{essere} & \iti{to be} & \itb{stare} & \iti{to be/to stay} & \itb{avere} & \iti{to have} \\
         \hline
...
(Table \ref{tab:tVerbsPresentMangiare}). In the present \textbf{continuous} form (i.e., 
with \iti{stare}), the gerund \iti{mangiando} is used, e.g., \iti{io sto mangiando}, I am eating. 
The present \textbf{conditional} form, `would eat', is shown in 
Table \ref{tab:tVerbsConditionalMangiare}. For example you might say, in a restaurant, 
...
\centering
    \begin{tabular}{ r l }
         \itb{mangiare} & \iti{to eat}  \\
         \hline
         \itb{io}   & \iti{mangio}    \\
         \itb{tu}   & \iti{mangi}     \\
         \itb{lui/lei} & \iti{mangia} \\
         \itb{noi}  & \iti{mangiamo}  \\
         \itb{voi}  & \iti{mangiate}  \\
         \itb{loro} & \iti{mangiano}  
    \end{tabular}
    \caption{\iti{mangiare}, Present tense}
    \label{tab:tVerbsPresentMangiare}
\end{table}
...
\centering
    \begin{tabular}{ r l  }
         ...
         \hline
         \itb{io}   & \iti{mangerei}    \\
         \itb{tu}   & \iti{mangeresti}     \\
         \itb{lui/lei} & \iti{mangerebbe} \\
         \itb{noi}  & \iti{mangeremmo}  \\
    \end{tabular}
    \caption{\iti{mangiare}, Present conditional tense}
    \label{tab:tVerbsConditionalMangiare}
\end{table}
