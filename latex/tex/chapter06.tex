...
\section{ATPG: All the Possibilities Game} \label{0228-ATPG}
...
\section{Grammar} \label{0228-Grammar}
...
\begin{itemize}[noitemsep]
    \item I am happy. (Verb \textit{to be} + adjective \iti{happy}.)
    \item I am doing well. (Compound verb \textit{to be doing} + adverb \iti{well}.)
\end{itemize}
...
\section{Vocabulary} \label{0228-Vocabulary}
\subsection{Verbs}
\begin{table}[ht]
\centering
    \begin{tabular}{ r l | r l | r l }
...
\subsection{Phrases - in a restaurant}
\begin{itemize}
...
\section{Conversation: \iti{Al ristorante}} \label{0228-Conversation}
...
\section{Homework} \label{0228-Homework}
\begin{enumerate}
