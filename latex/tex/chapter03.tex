...
\section{ATPG: All the Possibilities Game} \label{0131-ATPG}

\begin{table}[ht]
\centering
    \begin{tabular}{ r l  | r l }
         \itb{tavolo} & \iti{table}            & \itb{gelato} & \iti{gelato}           \\
         \hline
         the          & \iti{il tavolo}        & the          & \iti{il gelato}        \\
         a            & \iti{un tavolo}        & a            & \iti{un gelato}        \\
         two          & \iti{due tavoli}       & two          & \iti{due gelati}       \\
         good         & \iti{un buon tavolo}   & good         & \iti{un buon gelato}   \\
         expensive    & \iti{un tavolo caro}   & expensive    & \iti{un gelato caro}   \\         
         new          & \iti{un nuovo tavolo}  & new          & \iti{un nuovo gelato}  \\
         big          & \iti{un tavolo grande} & big          & \iti{un gelato grande} \\
         my           & \iti{il mio tavolo}    & my           & \iti{il mio gelato}    \\
         your         & \iti{il tuo tavolo}    & your         & \iti{il tuo gelato}    \\
         his/her      & \iti{il suo tavolo}    & his/her      & \iti{il suo gelato}
    \end{tabular}
    \caption{ATPG}
    \label{tab:tATPG-Jan31}
\end{table}

\section{Pronunciation} \label{0131-Pronunciation}
...
\begin{enumerate}
    ...
    \item The combinations \iti{sce} and \iti{sci} are soft, like English `scene' and `science'.
\end{enumerate}
\begin{mdframed}
...
\section{Grammar} \label{0131-Grammar}
...
\section{Vocabulary} \label{0131-Vocabulary}
\subsection{Words}
...
\section{Homework} \label{0131-Homework}
\begin{enumerate}
