...
\textmd{Clocks in Italy use the 24-hour system, although speakers might use expressions like 
	\iti{di sera} in casual conversation. So for example a train announcer might say 
	\iti{Il treno per Bologna parte alle quindici} but you might refer to the time as \iti{tre di sera}.
