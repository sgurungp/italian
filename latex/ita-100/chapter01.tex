...
\section{Grammar} \label{0117-Grammar}
...
\iti{la casa}. A few nouns end in \iti{-e}, e.g., \iti{il caffè}. 
Generally the \iti{-e} nouns are masculine, but there are exceptions, such as \iti{la stazione}.
...
as illustrated in Table \ref{tab:tArticles}. Plurals end in \iti{-i} for masculine and \iti{-e}
for feminine, typically replacing the terminal \iti{-o} and \iti{-a} with \iti{-o} and \iti{-e}
respectively. 
...
\subsection{Adjectives}
	...
	Plural adjectives normally end like the same-gendered noun, e.g., masculine plural 
	nouns end in \iti{-i} most of the time, so adjectives describing such nouns end in 
	\iti{-i} as well: \iti{tavolo} $\rightarrow$ \iti{tavoli} and 
	\iti{tavolo rosso} $\rightarrow$ \iti{tavoli rossi}. Similarly, \iti{la donna alta} 
	$\rightarrow$ \iti{le donne alte}. But, of course there will be exceptions.
...
as in, ``London is a big city'' vs. ``London is a great city''. As an adjective, \iti{molto}
is pluralized following the standard rules, e.g. \iti{molti tavoli} or \iti{molte stazioni}.
...
%--------------------------------------------------------------------------------
% Manual page break. Not good LaTeX practice, but makes the document
% flow better, or else the next section only has the opening and one line.
%--------------------------------------------------------------------------------
\newpage
...
\section{Vocabulary} \label{0117-Vocabulary}
\subsection{Verbs}
...
\centering
    \begin{tabular}{ r l | r l }
         \itb{essere} & \textit{to be} & \itb{avere} & \textit{to have} \\
         \hline
